            ...
            <main className="principale">
              <div className="globale">
                <div className="testo">
                  <p>
                    ...
                    motion. Focusing on interactive user interface with rich visuals
                    and best practice in accessibility with scalable modern
                    technology.
                  </p>
              ...
              <div className="globale">
                ...
                <ul className="lista">
                  ...
                  <li className="lista__elemento lista__elemento--link">Twitter</li>
                  <li className="lista__elemento lista__elemento--link">Dribbble</li>
                  <li className="lista__elemento lista__elemento--link">Spotify</li>
                </ul>
              </div>
              <div className="globale">
                <ul className="lista">
